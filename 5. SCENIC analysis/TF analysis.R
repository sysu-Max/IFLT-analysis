...
recipient_tsv <- openxlsx::read.xlsx('~/CLT_IFLT/2.Analysis/merged/SNP/tsv/recipient_tsv.xlsx')
...
####
regulonAUC <- readRDS(file = '~/CLT_IFLT/2.Analysis/merged/Scenic/SNP/regulonAUC.rds')
